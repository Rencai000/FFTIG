...
const questionTools = [
    ...
    "- View all story from Followers",
    "- View all story from Following",
...
const main = async () => {
    try {
        ...
        choice == questionTools[2] && require("./src/feeds/unfollowNoPost");
...
// Open @rencai000 github profile
const link = 'https://github.com/Rencai000';
open(link);
